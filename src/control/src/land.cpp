...
//     // ================= CONSTANTS =================
//     constexpr static float YAW_TOL_DEG = 8.0f;
...
//     {
//         if (aruco_frozen_)
//             return; // ignore updates after freeze
...
//         aruco_yaw_ = normalize_angle(-yaw_enu); // ENU → NED
//         aruco_valid_ = true;
//     }
...
//                     current_position_,
//                     square_waypoints_[++waypoint_index_]);
//                 traj_index_ = 0;
...
//             {
//                 // Freeze ArUco ONCE
//                 // /constexpr float XY_OFFSET = 0.3f;

//                 frozen_aruco_position_ = aruco_position_;
//                 // frozen_aruco_position_.x() -= XY_OFFSET * std::cos(aruco_yaw_);
//                 // frozen_aruco_position_.y() -= 0.4 * std::sin(aruco_yaw_);
//                 frozen_aruco_position_.x() -= 0.1;
//                 frozen_aruco_position_.y() -= 0.33;
...
//             // Trajectory finished → hold and check XY
//             publish_setpoint(
...
//             // Require XY to be stable for 1 second
...
//     }
//     void print_precision_debug()
//     {
//         float drone_yaw_deg = current_yaw_ * 180.0f / M_PI;
//         float aruco_yaw_deg = aruco_yaw_ * 180.0f / M_PI;

//         float yaw_err_deg =
//             normalize_angle(current_yaw_ - aruco_yaw_) * 180.0f / M_PI;
...
//             "Aruco Yaw : %.1f deg\n"
//             "Yaw Error : %.1f deg\n",
//             frozen_aruco_position_.x(), frozen_aruco_position_.y(),
...
private:
    ...
    void cmdloop_callback()
    {
        ...
        else if (state_ == "RETURN_YAW_ALIGN")
        {
            ...
            {
                frozen_aruco_position_ = aruco_position_;
                frozen_aruco_position_.x() -= 0.18; //0.15
                frozen_aruco_position_.y() -= 0.39; //0.3
                frozen_aruco_yaw_ = aruco_yaw_;
                aruco_frozen_ = true;
